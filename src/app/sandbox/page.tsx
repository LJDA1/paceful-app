          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ color: '#5C574F', marginBottom: '24px', fontSize: '15px' }}>
                Want to receive insights about the ERS API? (Optional)
              </p>
          ...
          <div>
            ...
            <div style={{
              ...
              <p style={{ color: 'rgba(255,255,255,0.7)', marginBottom: '24px' }}>
                Get your API key in 30 seconds and start building with the ERS API.
              </p>
              <Link
                href="/partners/signup"
                style={{
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ borderBottom: '1px solid #E8E2DA' }}>
              ...
              <th style={{ textAlign: 'center', padding: '12px 8px', fontSize: '13px', color: '#9A938A', fontWeight: 600 }}>ERS Score</th>
