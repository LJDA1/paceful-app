...
const REASONING_TEMPLATES: Record<Tone, Record<Dimension, Record<'high' | 'mid' | 'low', string>>> = {
  ...
  casual: {
    emotional_stability: {
      high: "Emotional patterns appear stable with consistent mood regulation and effective recovery.",
      mid: "Emotional stability is developing with some variance in mood patterns.",
      low: "Emotional regulation shows room for improvement. Support in this area may be beneficial.",
    },
    self_reflection: {
      high: "Strong self-awareness evident with clear recognition of personal patterns.",
      mid: "Self-awareness is building with emerging pattern recognition.",
      low: "Self-reflection capacity is in early stages of development.",
    },
    coping_capacity: {
      high: "Effective coping strategies in place with consistent application.",
      mid: "Coping skills are developing with variable effectiveness.",
      low: "Building a reliable coping toolkit is a current priority.",
    },
    behavioral_engagement: {
      high: "Consistent engagement patterns with well-maintained routines.",
      mid: "Engagement shows variability with some routine maintenance.",
      low: "Engagement has been limited. Routine re-establishment may be needed.",
    },
    social_readiness: {
      high: "Social readiness is evident with openness to new connections.",
      mid: "Social engagement shows mixed patterns with variable comfort levels.",
      low: "Social connection remains a developing area requiring gradual exposure.",
    },
  },
  motivational: {
    emotional_stability: {
      high: "Emotional regulation shows significant strength. Consistent mood patterns indicate meaningful progress.",
      mid: "Emotional balance is developing well. Each challenge presents a growth opportunity.",
      low: "This represents a starting point with clear potential for improvement.",
    },
    self_reflection: {
      high: "Self-awareness is well-developed. Understanding personal patterns provides valuable insight.",
      mid: "Pattern recognition is emerging. Each insight builds toward greater self-understanding.",
      low: "Self-discovery is an ongoing process with incremental progress.",
    },
    coping_capacity: {
      high: "Coping strategies are well-established and demonstrating effectiveness.",
      mid: "Resilience is building steadily. Expanding the coping toolkit continues to strengthen capacity.",
      low: "Building coping skills is a valuable investment in long-term wellbeing.",
    },
    behavioral_engagement: {
      high: "Consistent engagement demonstrates commitment to personal growth.",
      mid: "Ongoing effort is evident. Incremental steps lead to meaningful change.",
      low: "Each day presents new opportunities for engagement and routine building.",
    },
    social_readiness: {
      high: "Openness to connection is well-developed. Social engagement opportunities are accessible.",
      mid: "Social readiness is progressing at an appropriate pace. Gradual exposure supports growth.",
      low: "Social connection develops when foundational work is in place. Current focus on individual growth is appropriate.",
    },
  },
};
